...
<div class="wrapper">
    <div class="car-text">
        <form action="<%=request.getContextPath()%>/auth" method="post">
            ...
            <span style="color:#ff0000; font-size: 18px; padding-left: 200px"><%=request.getAttribute("error")%></span>
            <%}%>
            <div class="car-save">
                <button type="submit" onclick="return validateLogin()">sign in</button>
            </div>
        </form>
    </div>
</div>
